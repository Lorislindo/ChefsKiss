        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="{$Immagine1}" alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">{$Data_Post1}</div>
                            <h2 class="card-title">{$Titolo_Post1}</h2>
                            <p class="card-text">{$Descrizione_Post1}</p>
                        </div>
                    </div>
